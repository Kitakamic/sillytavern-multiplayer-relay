...
export const CommandType = Object.freeze({
    ...
    STORY_MESSAGE_UPDATE: 'story.message.update',
    STORY_MESSAGE_DELETE: 'story.message.delete',
...
export const EventType = Object.freeze({
    ...
    STORY_MESSAGE_UPDATED: 'story.message.updated',
    STORY_MESSAGE_DELETED: 'story.message.deleted',
